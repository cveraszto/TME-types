...
#file = os.path.join( root_folder, 'scaled_densities_new.pickle' )
...
# Get the set of all clusters present in the result_dataframes
all_clusters = set()
for df in scaled_combined_result_dataframes.values():
    all_clusters.update(df.index)
...
# save_nrrd = f'{root_folder}scaled_nrrd_CCFv3_0/'
# #2
...
# save_nrrd = f'{root_folder}scaled_nrrd/'
# #3
data_folder = "/gpfs/bbp.cscs.ch/project/proj84/piluso/share/general/warped_augmented_CCFv3/"
CCFv3_0, _ = nrrd.read(f'{data_folder}annotation_25_2022_CCFv3a.nrrd')
save_nrrd = f'{root_folder}scaled_nrrd_CCFv3a/'
