...
if len(sys.argv) < 2:
    ...
    clusters_to_process = clusters[x:x+3]
    ...
    for cluster in clusters_to_process:
        ...
        file = f"{write}metadata/averages/20230830/median/{clustername}.csv"
        ...
        file = f"{write}/metadata/averages/20230830/mean/{clustername}.csv"
